...
;AutoSAE_Safety.c,138 :: 		if(arm_state == 0) {
	...
	BTFSS      STATUS+0, 2
	GOTO       L_main43
;AutoSAE_Safety.c,140 :: 		if(PORTB.B3 == 0) {
	BTFSC      PORTB+0, 3
	GOTO       L_main44
...
;AutoSAE_Safety.c,153 :: 		}
	GOTO       L_main46
L_main43:
;AutoSAE_Safety.c,154 :: 		else if(arm_state == 1 || arm_state == 3) {
	MOVF       _arm_state+0, 0
	XORLW      1
	BTFSC      STATUS+0, 2
	GOTO       L__main73
...
;AutoSAE_Safety.c,155 :: 		if(PORTB.B3 == 1) { arm_state = -1; UART1_Write_Text("AF 1\n"); }   // Arm button
	...
	CALL       _UART1_Write_Text+0
L_main50:
;AutoSAE_Safety.c,156 :: 		if(PORTB.B4 == 0) { arm_state = -1; PORTB.B0 = 1; UART1_Write_Text("AF 2\n"); }  // Throttle
	BTFSC      PORTB+0, 4
	GOTO       L_main51
	MOVLW      255
	MOVWF      _arm_state+0
	...
	CALL       _UART1_Write_Text+0
L_main51:
;AutoSAE_Safety.c,157 :: 		}
	GOTO       L_main52
L_main49:
;AutoSAE_Safety.c,158 :: 		else if(arm_state == 2) {
	MOVF       _arm_state+0, 0
	XORLW      2
	BTFSS      STATUS+0, 2
	GOTO       L_main53
;AutoSAE_Safety.c,159 :: 		UART1_Write_Text("A 2\n");
	MOVLW      ?lstr11_AutoSAE_Safety+0
	MOVWF      FARG_UART1_Write_Text_uart_text+0
	CALL       _UART1_Write_Text+0
;AutoSAE_Safety.c,160 :: 		PORTB.B6 = 1;
	BSF        PORTB+0, 6
...
;AutoSAE_Safety.c,164 :: 		}
	GOTO       L_main54
L_main53:
;AutoSAE_Safety.c,165 :: 		else if(arm_state == 4) {
	MOVF       _arm_state+0, 0
	XORLW      4
	BTFSS      STATUS+0, 2
	GOTO       L_main55
;AutoSAE_Safety.c,166 :: 		UART1_Write_Text("A 4\n");
	MOVLW      ?lstr13_AutoSAE_Safety+0
	MOVWF      FARG_UART1_Write_Text_uart_text+0
	CALL       _UART1_Write_Text+0
;AutoSAE_Safety.c,167 :: 		arm_interruptcount = 0;
	CLRF       _arm_interruptcount+0
	CLRF       _arm_interruptcount+1
;AutoSAE_Safety.c,168 :: 		arm_state = 5;
	MOVLW      5
	MOVWF      _arm_state+0
;AutoSAE_Safety.c,169 :: 		UART1_Write_Text("A 5\n");
...
;AutoSAE_Safety.c,170 :: 		}
	GOTO       L_main56
L_main55:
;AutoSAE_Safety.c,171 :: 		else if(arm_state == 5 || arm_state == 7) {
	MOVF       _arm_state+0, 0
	XORLW      5
	BTFSC      STATUS+0, 2
	GOTO       L__main72
	...
	GOTO       L_main59
L__main72:
;AutoSAE_Safety.c,172 :: 		if(PORTB.B4 == 0) { arm_state = -1; PORTB.B0 = 1; UART1_Write_Text("AF 3\n"); }      // Throttle
	BTFSC      PORTB+0, 4
	GOTO       L_main60
	MOVLW      255
	MOVWF      _arm_state+0
...
;AutoSAE_Safety.c,173 :: 		}
	GOTO       L_main61
L_main59:
;AutoSAE_Safety.c,174 :: 		else if(arm_state == 6 && PORTB.B3 == 1) {
	MOVF       _arm_state+0, 0
	XORLW      6
	BTFSS      STATUS+0, 2
	GOTO       L_main64
	...
	GOTO       L_main64
L__main71:
;AutoSAE_Safety.c,175 :: 		UART1_Write_Text("A 6\n");
	MOVLW      ?lstr16_AutoSAE_Safety+0
	MOVWF      FARG_UART1_Write_Text_uart_text+0
	CALL       _UART1_Write_Text+0
;AutoSAE_Safety.c,176 :: 		PORTA.B1 = 0;
	BCF        PORTA+0, 1
;AutoSAE_Safety.c,177 :: 		arm_interruptcount = 0;
	CLRF       _arm_interruptcount+0
	CLRF       _arm_interruptcount+1
;AutoSAE_Safety.c,178 :: 		arm_state = 7;
	MOVLW      7
	MOVWF      _arm_state+0
;AutoSAE_Safety.c,179 :: 		UART1_Write_Text("A 7\n");
...
;AutoSAE_Safety.c,180 :: 		}
	GOTO       L_main65
L_main64:
;AutoSAE_Safety.c,181 :: 		else if(arm_state == 8) {
	MOVF       _arm_state+0, 0
	XORLW      8
	BTFSS      STATUS+0, 2
	GOTO       L_main66
;AutoSAE_Safety.c,182 :: 		UART1_Write_Text("A 9\n");
	MOVLW      ?lstr18_AutoSAE_Safety+0
	MOVWF      FARG_UART1_Write_Text_uart_text+0
	CALL       _UART1_Write_Text+0
;AutoSAE_Safety.c,183 :: 		arm_state = 9;
	MOVLW      9
	MOVWF      _arm_state+0
;AutoSAE_Safety.c,184 :: 		}
	GOTO       L_main67
L_main66:
;AutoSAE_Safety.c,185 :: 		else if(arm_state == -1) {
	MOVF       _arm_state+0, 0
	XORLW      255
	BTFSS      STATUS+0, 2
	GOTO       L_main68
;AutoSAE_Safety.c,186 :: 		if(PORTB.B3 == 1) { PORTB.B6 = 0; arm_state = 0; }
	BTFSS      PORTB+0, 3
	GOTO       L_main69
	BCF        PORTB+0, 6
	CLRF       _arm_state+0
