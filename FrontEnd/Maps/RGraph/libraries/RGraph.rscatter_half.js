        ...
        */
        this.Draw = function ()
        {
            ...
            */
            ...
            this.radius  = (Math.min((ca.width - this.gutterLeft - this.gutterRight)/ 2, ca.height - this.gutterTop - this.gutterBottom));
            this.centerx = ((ca.width - this.gutterLeft - this.gutterRight) / 2) + this.gutterLeft;
            this.centery = ((ca.height - this.gutterTop - this.gutterBottom)) + this.gutterTop;
            this.coords  = [];
            this.coords2 = []
        ...
        */
        this.DrawBackground = function ()
        {
            ...
            for (var i=0,len=this.radius; i<=len; i+=r) {
                ...
                // Radius must be greater than 0 for Opera to work
                co.arc(this.centerx, this.centery, i, PI, TWOPI, 0);
            }
            co.stroke();
            ...
            for (var i=(this.centery - this.radius); i<(this.centery); i+=(this.radius / 10)) {
            ...
            co.lineTo(Math.round(this.centerx), this.centery);
