    ...
    */
    RGraph.Scatter = function (id, data)
    {
        ...
        */
        this.Set = function (name, value)
        {
            ...
            */
            if (name == 'chart.yaxispos' && value != 'left' && value != 'right' && value != 'center') {
                alert("[SCATTER] chart.yaxispos should be left or right or center. You've set it to: '" + value + "' Changing it to left");
                value = 'left';
            }
	...
	this.GetScale = function ()
        ...
        */
		...
		else if(prop['chart.yaxispos'] == 'center') {  // Modified (added)...
		    co.moveTo((ca.width - this.gutterLeft - this.gutterRight)/2 + this.gutterLeft, this.gutterTop);
                    co.lineTo((ca.width - this.gutterLeft - this.gutterRight)/2 + this.gutterLeft, ca.height - this.gutterBottom);
		}
		else {
